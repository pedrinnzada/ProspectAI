...
export default function ContactCard({ contact, onStatus, onFavorite, onDelete }) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl px-3 sm:px-4 py-3 hover:border-gray-300 transition group">
      {/* Top row: dot + name + badges + fav + delete */}
      ...
      <div className="flex items-center gap-2 pl-4">
        ...
        {contact.phone && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="ml-auto flex-shrink-0 bg-gray-900 text-white text-[11px] font-medium rounded-lg px-3 py-1.5 flex items-center gap-1.5 hover:bg-[#e5272a] transition"
          >
            <WAIcon />
